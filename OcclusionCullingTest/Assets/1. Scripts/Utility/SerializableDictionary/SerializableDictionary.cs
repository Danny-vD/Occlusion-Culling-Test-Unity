...
namespace Utility.SerializableDictionary
{
	...
	public class SerializableDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, ISerializationCallbackReceiver, IEnumerable<SerializableKeyValuePair<TKey, TValue>>
	{
		#region Fields
